    ...
    return (
        ...
        <Box w={{base:"100%",md:"80%"}} >
            ...
            <Box h="25%">
                ...
                bgRepeat="no-repeat" 
                bgSize="cover"
                h="15vh" position={"relative"}>
                    <Box  mt={{base:"15%",md:"5%"}} ml={{base:"30%",md:"5%"}} position={"absolute"}>
                        <Avatar size='xl'
                ...
                <Box>
                    ...
                    <Box mt="2%" w="80%" position={"absolute"} display={"flex"} flexDirection={{md:"row",base:"column-reverse"}} justifyContent={"space-between"}>
                        ...
                        <Box ml={{base:"5%",md:"3%"}} mt={{base:"3%",md:"1%"}}>
                            <Text> {name}</Text>
                            <Text mt="3%"> {email} </Text>
                            <Flex mt="3.3%" justifyContent={"space-between"}>
                        ...
                        <Button transition={"all ease-in-out 100ms"} bg="black" color="white"
                                _hover={{ transform: "scale(1.05)" }} 
                                display={"flex"} justifyContent={"space-between"} 
                                ml={{md:"0%",base:"25%"}} mt={{base:"15%",md:"0%"}} mr="5%" borderRadius={25} 
                                w={{md:"12%",base:"60%"}} >
                ...
                <Flex direction={{md:"row",base:"column"}} justifyContent={"space-between"} h="100%" mb="8">
                    ...
                    <Box mt={4} w={{base:"100%",md:"40%"}} maxHeight={{base:"auto",md:"100vh"}} overflowY={{base:"none",md:"scroll"}}>
                        ...
                        {/* <Flex direction={"column"} pt="2%" > */}
                            ...
                            <Box boxShadow={"dark-lg"}  borderWidth={1} mb="4" h="14rem" w="100%">
                                ...
                                </Flex>
                                {
                                    skills.length === 0 ?
                                    <Box
                                    backgroundImage="url('https://e7.pngegg.com/pngimages/170/753/png-clipart-computer-icons-skill-skill-miscellaneous-text.png')"
                                    bgRepeat="no-repeat" 
                                    bgSize="cover"
                                    >
                            ...
                            <Box boxShadow={"dark-lg"} mt="1%" h="14rem" mb="4" borderWidth={1}  w="100%">
                                <Flex justifyContent={"space-between"}>
                            ...
                            <Box boxShadow={"dark-lg"} mt="1%" mb="4" h="14rem" borderWidth={1}  w="100%">
                                <Flex justifyContent={"space-between"}>
                    ...
                    <Box mt={{base:"0%",md:"1%"}} w={{base:"100%",md:"40%"}}>
